...
Real-time network packet sniffer with anomaly detection and visual reporting
# [readme.md.txt](https://github.com/user-attachments/files/27552875/readme.md.txt)
 Network Traffic Analyzer
...
| `Pandas` | CSV reading and data aggregation |
| `Matplotlib` | Chart generation |
| `CSV / OS` | File I/O and log management |
